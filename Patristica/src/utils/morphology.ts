...
export const GREEK_TAG_EXAMPLES: Record<string, string> = {
  ...
  'Middle/Passive Deponent': '"I labour, striving" (ἀγωνίζομαι) — middle/passive ending, active sense.',
  'Impersonal':      '"It is necessary" (δεῖ) — no personal subject; the action simply stands.',
  ...
  'Imperative Participle': '"Let love be genuine…" — a participle used as a command (Romans 12:9).',
...
export const HEBREW_TAG_EXAMPLES: Record<string, string> = {
  ...
  'Nithpael':  '"They were warned" — rare late-Hebrew reflexive/passive form.',
  'Poel':      '"He roused" — intensive built on a hollow root, patterning like Piel.',
  'Hithpoel':  '"He rouses himself" — reflexive of the Poel stem.',
...
export const TAG_DEFINITIONS: Record<string, string> = {
  ...
  'Middle/Passive Deponent': 'Middle or passive in form but active in meaning — the ending alone cannot tell which.',
  'Impersonal':      'Used without a personal subject — "it is necessary", "it is lawful".',
  // Mood
  ...
  'Imperative Participle': 'A participle carrying the force of a command.',
  // Person
